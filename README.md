...
DASSH-nc is a fork of the ANL DASSH (Ducted Assembly Steady State Heat Transfer Software) repository (https://github.com/dassh-dev/dassh). 
...
Modifications are currently under developemnt at _new_ cleo to extend its application domain. 
...
User and Theory manuals cover the original _dassh_. 
Please refer to #6 for documentation updates related to modifications implemented in this fork. 
