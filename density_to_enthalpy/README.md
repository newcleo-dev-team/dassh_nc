This folder contains the evaluation of the density-to-enthalpy conversion method, which is based on the derivation of a polynomial fitting the density-enthalpy data couples. It is only present in the current branch because it motivates the implementation choices regarding density-to-enthalpy conversion. 
